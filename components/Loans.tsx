...
const Loans = ({ setSelectedPage }: Props) => {
  return (
    <section id="loans" className="mx-auto min-h-full bg-gray-20 py-20 ">
      <motion.div
        onViewportEnter={() => {
            ...
            <div className="mx-10 md:mx-40">
              ...
              >
                <p className="my-5">
                  ...
                  that allows consumers to make purchases from approved
                  retailers and pay for them at a future date, interest free.
                </p>
                <p className="mb-5">
                  <strong>DorsetPay</strong> makes larger value items more
                  affordable for shoppers as they can spread the cost of
                  purchase over a period of up to 90 days at no extra cost.
                </p>
